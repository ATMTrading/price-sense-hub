  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center space-x-2">
        ...
        <h2 className="text-2xl font-bold">Restorio.sk Book Import</h2>
      </div>
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div>
            <Label htmlFor="feed-select">Book Feed Source</Label>
            ...
            {bookCategories.map((category) => (
              <div
                ...
                className={`flex items-center space-x-2 p-3 rounded-lg cursor-pointer hover:bg-muted transition-colors ${
                  selectedCategories.includes(category.id) ? 'bg-primary/10 border border-primary' : 'border'
                }`}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <Card>
          ...
          <CardContent>
            <Button 
              onClick={importBooksToCategories} 
